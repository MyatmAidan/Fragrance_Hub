...
<div class="col-md-2">
  <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#add-category">
      ...
      <tbody>
        <?php foreach ($categories as $category): ?>
          <tr>
            ...
            <td><?php echo htmlspecialchars($category->cat_description); ?></td>
            <td class="text-center"><?php echo (int)$category->product_count; ?></td>
            <td class="text-center">
              <a href="category-data.php?delete=<?php echo (int)$category->cat_id; ?>" onclick="return confirm('Are you sure you want to delete this category?');">

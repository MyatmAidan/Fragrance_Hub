    ...
    <div class="col-xs-offset-4 col-sm-4 col-sm-offset-4">
      ...
      <form action="includes/register-exec.php" method="post">
        ...
        <div class="form-group">
          ...
          <div class="controls">
            <input type="text" class="form-control" placeholder="Fill your Address" name="address">
          </div>
        </div>
        <div class="form-group">
          <label class="control-label">Phone</label>
          <div class="controls">
            <input type="text" class="form-control" placeholder="Fill your Phone number" name="phone">
          </div>
        </div>
